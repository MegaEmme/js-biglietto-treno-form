const userDistance = prompt('ins');//document.getElementById('km');
console.log(parseInt(userDistance));
const finalPrice = userDistance * 0.21;
console.log(finalPrice.toFixed(2));
const userAge = prompt('age');//document.getElementById('age');
console.log(parseInt(userAge));
const generate = document.getElementById('button');
console.log(generate);

generate.addEventListener('click',function(){
    console.log(`hai ${userAge} anni e il biglietto costa ${finalPrice}`);
})
